console.log("Atlas map script is loading!");
alert("Atlas map script is loading!");
            ...
            .then(geojson => {
                regionsLayer = L.geoJSON(geojson, {
                    ...
                    onEachFeature: (feature, layer) => {
                        // Add click event to show conversations
                        layer.on('click', () => {
...
function addCountryIcons(feature, layer) {
    const regionName = feature.properties.ADMIN;
    const center = layer.getBounds().getCenter();
    
    console.log(`Country from GeoJSON: ${regionName}, Has icon: ${countryIcons[regionName] ? 'Yes' : 'No'}`);
    ...
    if (countryIcons[lookupName] || countryIcons['default']) {
